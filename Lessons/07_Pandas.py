...
if int(user_input) == 1:
    ...
    # let's read in the biggest file I could find in our systems. Note that you can specify seperator. Default is ","
    data_file = pandas.read_csv("Data/plant_profiles.csv", sep=";")
